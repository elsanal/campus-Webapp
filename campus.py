...
def saveScho_toDatabase(form, logo, picture_path):
    ...
    u'bachelor' : u'{}'.format(request.form.get('bachelor')),
    u'master' : u'{}'.format(request.form.get('master')),
    u'PhD' : u'{}'.format(request.form.get('PhD')),
    u'logo' : logoUrl,
    u'webUrl' : u'{}'.format(request.form.get('web')),
    u'date'  : u'{}'.format(form.post_date),
    u'order': u'{}'.format(form.post_order),
...
def saveJob_toDatabase(form, logo, picture_path):
    ...
    u'deadline' : form.deadline.data.strftime('%Y/%m/%d'),
    u'internship' : u'{}'.format(request.form.get('internship')),
    u'logo' : logoUrl,
    u'webUrl' : u'{}'.format(request.form.get('web')),
    u'order': u'{}'.format(form.post_order),
    })   
